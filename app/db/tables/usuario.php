...
class usuario extends model {
    ...
    public static function table(){
        return (new table(self::table, comment: "Tabela de usuários"))
                ->addColumn((new column("id","INTEGER"))->isPrimary()->isNotNull()->setComment("ID do usuário"))
                ...
                ->addColumn((new column("tipo_usuario","INTEGER"))->isNotNull()->setComment("Tipo de usuário: 0 -> ADM, 1 -> empresa, 2 -> funcionario, 3 -> usuário, 4 -> cliente cadastrado"))
                ->addColumn((new column("id_empresa","INTEGER"))->isForeingKey(empresa::table())->setComment("ID da empresa"));
    }
}