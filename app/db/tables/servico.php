...
class servico extends model {
    ...
    public static function table(){
        return (new table(self::table, comment: "Tabela de serviços"))
                ->addColumn((new column("id","INTEGER"))->isPrimary()->isNotNull()->setComment("ID do serviço"))
                ...
                ->addColumn((new column("id_empresa","INTEGER"))->isNotNull()->setComment("ID da empresa"));
    }
