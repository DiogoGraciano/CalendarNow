...
class funcionario extends model {
    ...
    public static function table(){
        return (new table(self::table, comment: "Tabela de funcionarios"))
                ->addColumn((new column("id","INTEGER"))->isPrimary()->isNotNull()->setComment("ID do funcionario"))
                ->addColumn((new column("id_usuario","INTEGER"))->isNotNull()->isForeingKey(usuario::table())->setComment("ID da tabela usuario"))
