...
class agendamento extends model {
    ...
    public static function table(){
        return (new table(self::table,comment:"Tabela de agendamentos"))
                ->addColumn((new column("id","INTEGER"))->isPrimary()->setComment("ID agendamento"))
                ->addColumn((new column("id_agenda","INTEGER"))->isNotNull()->isForeingKey(agenda::table())->setComment("ID da tabela agenda"))
                ->addColumn((new column("id_usuario","INTEGER"))->isForeingKey(usuario::table())->setComment("ID da tabela usuario"))
                ->addColumn((new column("id_cliente","INTEGER"))->isForeingKey(cliente::table())->setComment("ID da tabela cliente"))
                ->addColumn((new column("id_funcionario","INTEGER"))->isForeingKey(funcionario::table())->setComment("ID da tabela funcionario"))
                ...
                ->addColumn((new column("id_status","INTEGER"))->isForeingKey(status::table())->isNotNull()->setComment("id do Status do agendamento"))
