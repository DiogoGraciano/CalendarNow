...
final class funcionarioController extends controller
{
    ...
    public function manutencao($parameters = [])
    {
        ...
        $form->setDoisInputs(
            $select_agenda,
            $elements->input("espacamento_agenda","Subdivisão de horario em minutos",$dadoFuncionario->espacamento_agenda?:30,type_input:"number",extra_input:'min="10" max="480"')
        );
    ...
    public function action()
    {
        ...
        try {
            if ($id_empresa = $this->getValue("id_empresa")) {
                ...
                if ($id_usuario) {
                    $id_funcionario = funcionarioModel::set($id_usuario, $nome, $cpf_cnpj, $email, $telefone, $hora_ini, $hora_fim, $hora_almoco_ini, $hora_almoco_fim, $espacamento_agenda, $dias, $id_funcionario);
                    if ($id_funcionario) {
