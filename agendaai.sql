...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 16-Mar-2024 às 15:01
...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `nome` varchar(250) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'nome',
  `codigo` varchar(7) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `agendamento` (
  ...
  `titulo` varchar(150) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'titulo do agendamento',
  `dt_ini` datetime NOT NULL COMMENT 'data inicial do agendamento',
  `dt_fim` datetime NOT NULL COMMENT 'data final do agendamento',
  `cor` varchar(7) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'cor do agendamento',
  `total` decimal(10,2) NOT NULL,
  `status` int NOT NULL COMMENT '1 -> finalizado 0 -> em andamento 99 -> Cancelado',
  `obs` varchar(400) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `agendamento_item` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `getItemByServico` (`id_agendamento`,`id_servico`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `id_funcionario` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cliente_empresa` (`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `telefone` varchar(13) COLLATE utf8mb4_general_ci NOT NULL,
  `cnpj` varchar(14) COLLATE utf8mb4_general_ci NOT NULL,
  `razao` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `fantasia` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `endereco` (
  ...
  `bairro` varchar(150) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'bairro',
  `rua` varchar(250) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'endereco',
  `numero` int NOT NULL,
  `complemento` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `dias` varchar(27) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'dom,seg,ter,qua,qui,sex,sab\r\n\r\nrepresentaria que o funcionario trabalharia todos os dias da semana',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `nome` varchar(500) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'nome do usuario',
  `cpf_cnpj` varchar(14) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telefone` varchar(11) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `senha` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'senha do usuario',
  `email` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'email do usuario',
